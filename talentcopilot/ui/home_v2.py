def render_home_v2(*args, **kwargs):
    try:
        ...
        st.title("Welcome to TalentCopilot-AI")
        st.caption("Your explainable AI copilot for recruitment decisions.")

        cols = st.columns(4)
        labels = ['Create a recruitment', 'Analyze candidates', 'Review evidence', 'Generate recommendations']
