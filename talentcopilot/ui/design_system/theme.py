...
def apply_enterprise_theme():
    ...
    st.markdown(
        ...
        .tc-brand-lockup {{display:flex;align-items:center;gap:.72rem;padding:.35rem .15rem 1rem;margin-bottom:.2rem;border-bottom:1px solid rgba(148,163,184,.16)}}
        ...
        .tc-mission-kicker,.tc-sidebar-section,.tc-sidebar-next-kicker {{text-transform:uppercase;letter-spacing:.1em;font-size:.61rem;font-weight:800;color:#6E86A9}}
        .tc-mission-role {{color:#F8FAFC;font-size:.89rem;font-weight:800;margin-top:.28rem;line-height:1.25}}
        .tc-mission-meta {{color:#91A7C5;font-size:.68rem;margin-top:.22rem}}
        .tc-sidebar-section {{margin:1rem .35rem .35rem}}
        [data-testid="stSidebar"] .stButton > button {{min-height:2.58rem;border-radius:11px;justify-content:flex-start;text-align:left;padding:.55rem .72rem;color:#C7D5E8;background:transparent;border:1px solid transparent;box-shadow:none;font-weight:690;font-size:.82rem}}
        [data-testid="stSidebar"] .stButton > button:hover {{transform:none;color:#FFFFFF;background:rgba(59,130,246,.13);border-color:rgba(125,211,252,.16)}}
        ...
        [data-testid="stSidebar"] details summary {{color:#B9CAE0;font-size:.78rem;font-weight:720}}
        ...
        .tc-sidebar-next-title {{color:#EDE9FE;font-weight:780;font-size:.8rem;margin-top:.22rem}}
