...
def render_interview_workspace():
    ...
    enterprise_hero(
        "Interview Workspace",
        "Prepare structured, evidence-based interviews with competency focus and decision readiness.",
    ...
    with col2:
        st.caption("Use this workspace to prepare and structure candidate interviews.")
    ...
    tab_readiness, tab_matrix, tab_plan, tab_questions, tab_notes, tab_scorecard = st.tabs([
        "Readiness",
        "Competency Matrix",
        "Interview Plan",
        "AI Questions",
